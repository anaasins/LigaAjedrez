...
import es.uv.gii.ligaajedrez.dao.ClubDao;
import es.uv.gii.ligaajedrez.dao.EntrenadorDao;
import es.uv.gii.ligaajedrez.dao.FederacionDao;
import es.uv.gii.ligaajedrez.dao.GerenteModelDao;
import es.uv.gii.ligaajedrez.dao.JugadorModelDao;
import es.uv.gii.ligaajedrez.dao.PartidaDao;
import es.uv.gii.ligaajedrez.dao.ReservaDao;
import es.uv.gii.ligaajedrez.dao.SedeDao;
import es.uv.gii.ligaajedrez.dao.TorneoClubDao;
import es.uv.gii.ligaajedrez.dao.TorneoDao;
import es.uv.gii.ligaajedrez.dao.TorneoParticipanteDao;
import es.uv.gii.ligaajedrez.dao.UsuarioDao;
import es.uv.gii.ligaajedrez.db.DB;
import es.uv.gii.ligaajedrez.factory.UsuarioFactory;

...
public class BorrarEntrenador extends javax.swing.JFrame {
     ...
     */
    public BorrarEntrenador(Usuario usuario, JFrame previousView) {
        initComponents();
    ...
    private void mostrarEntrenadores(){
       ...
       if (!entrenadoresAux.isEmpty()){
            for(Object j:entrenadoresAux)
            {
    ...
    private void initComponents() {
        ...
        deleteBtn.setText("Borrar entrenador");
        ...
        jLabel1.setText("Seleccionar un entrenador:");
